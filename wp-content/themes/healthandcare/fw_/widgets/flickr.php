 ...
 */
add_action( 'widgets_init', 'healthandcare_widget_flickr_load' );

/**
 * Register our widget.
 */
function healthandcare_widget_flickr_load() {
	register_widget( 'healthandcare_widget_flickr' );
}

/**
 * flickr Widget class.
 */
class healthandcare_widget_flickr extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_flickr', 'description' => esc_html__('Last flickr photos.', 'healthandcare') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 250, 'id_base' => 'healthandcare_widget_flickr' );

		/* Create the widget. */
		parent::__construct( 'healthandcare_widget_flickr', esc_html__('HealthandCARE - Flickr photos', 'healthandcare'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'count' => 6, 'description' => esc_html__('Last flickr photos', 'healthandcare') );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_username' )); ?>"><?php wp_kses(__('Flickr ID (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):', 'healthandcare'), $HEALTHANDCARE_GLOBALS['allowed_tags']); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_count' )); ?>"><?php esc_html_e('Number of photos:', 'healthandcare'); ?></label>
