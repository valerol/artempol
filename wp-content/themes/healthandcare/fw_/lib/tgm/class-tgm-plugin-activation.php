...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        public function no_items() {
            ...
            printf( wp_kses( esc_html__( 'No plugins to install or activate. <a href="%1$s" title="Return to the Dashboard">Return to the Dashboard</a>', 'tgmpa' ), $HEALTHANDCARE_GLOBALS['allowed_tags'] ), network_admin_url() );
            echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
            ...
            class TGM_Bulk_Installer extends WP_Upgrader {
                ...
                public function run( $options ) {
                    ...
                    public function install_strings() {
                        ...
                        $this->strings['downloading_package'] = wp_kses( esc_html__( 'Downloading install package from <span class="code">%s</span>&#8230;', 'tgmpa' ), $HEALTHANDCARE_GLOBALS['allowed_tags'] );
                ...
                class TGM_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
                    ...
                    public function add_strings() {
                        ...
                        // Default installation strings.
                            ...
                            $this->upgrader->strings['skin_update_failed_error']  = wp_kses( esc_html__( 'An error occurred while installing %1$s: <strong>%2$s</strong>.', 'tgmpa' ), $HEALTHANDCARE_GLOBALS['allowed_tags'] );
