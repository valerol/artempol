...
if ( !function_exists( 'healthandcare_template_testimonials_3_theme_setup' ) ) {
	add_action( 'healthandcare_action_before_init_theme', 'healthandcare_template_testimonials_3_theme_setup', 1 );
	function healthandcare_template_testimonials_3_theme_setup() {
		healthandcare_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 3/', 'healthandcare'),
...
// Template output
if ( !function_exists( 'healthandcare_template_testimonials_3_output' ) ) {
	function healthandcare_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
