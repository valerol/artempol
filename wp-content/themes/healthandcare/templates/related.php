...
if ( !function_exists( 'healthandcare_template_related_theme_setup' ) ) {
	add_action( 'healthandcare_action_before_init_theme', 'healthandcare_template_related_theme_setup', 1 );
	function healthandcare_template_related_theme_setup() {
		healthandcare_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'healthandcare'),
		...
		healthandcare_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'healthandcare'),
		...
		healthandcare_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'healthandcare'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'healthandcare'),
			'w'		 => 390,
			'h'		 => 390
		));
		healthandcare_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'healthandcare'),
...
// Template output
if ( !function_exists( 'healthandcare_template_related_output' ) ) {
	function healthandcare_template_related_output($post_options, $post_data) {
