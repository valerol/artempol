		...
		<div class="columns_wrap columns_fluid">
			<div class="column-1_4 contact_logo">
				<div class="logo">
					<a href="http://healthandcare.ancorathemes.com/">
						...
						<div class="logo_text">Health&amp;Care</div>
					</a>
				</div>
			</div>
			<div class="column-3_4 menu_main_wrap">
				...
				<?php wp_nav_menu( array ( 
					...
					'menu_class' 		=> 'menu_main_nav inited sf-js-enabled sf-arrows',
					'menu_id'         	=> 'menu_main',
					'fallback_cb'     	=> 'wp_page_menu', ) ); ?>
				<nav class="menu_main_nav_area" role="navigation">
					<ul class="menu_main_nav inited sf-js-enabled sf-arrows" id="menu_main">
						<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-79" id="menu-item-79"><a class="sf-with-ul">Home</a>
							<ul class="sub-menu animated fast none" style="display: none;">
