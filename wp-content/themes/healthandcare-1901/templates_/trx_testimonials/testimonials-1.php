...
if ( !function_exists( 'healthandcare_template_testimonials_1_theme_setup' ) ) {
	add_action( 'healthandcare_action_before_init_theme', 'healthandcare_template_testimonials_1_theme_setup', 1 );
	function healthandcare_template_testimonials_1_theme_setup() {
		healthandcare_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 1/', 'healthandcare'),
			'thumb_title'  => esc_html__('Avatar (small)', 'healthandcare'),
			'w'		 => 75,
			'h'		 => 75
		));
	}
...
// Template output
if ( !function_exists( 'healthandcare_template_testimonials_1_output' ) ) {
	function healthandcare_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
