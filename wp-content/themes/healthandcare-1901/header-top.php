<div class="top_panel_top">
	<div class="content_wrap clearfix">
		<div class="top_panel_top_contact_area">
			...
			<span class="contact_label contact_phone">Телефон</span>
			<span class="contact_icon icon-home"></span>
			<span class="contact_label contact_address_1">Адрес</span>
		</div>
		<div class="top_panel_top_user_area">
			<div class="top_panel_top_open_hours icon-clock">Режим работы</div>
			<div class="top_panel_top_search">Поиск</div>
