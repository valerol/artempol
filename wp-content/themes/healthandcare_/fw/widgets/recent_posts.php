 ...
 */
add_action( 'widgets_init', 'healthandcare_widget_recent_posts_load' );

/**
 * Register our widget.
 */
function healthandcare_widget_recent_posts_load() {
	register_widget('healthandcare_widget_recent_posts');
}

/**
 * Recent posts Widget class.
 */
class healthandcare_widget_recent_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_posts', 'description' => esc_html__('The recent blog posts (extended)', 'healthandcare'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'healthandcare_widget_recent_posts');

		/* Create the widget. */
		parent::__construct( 'healthandcare_widget_recent_posts', esc_html__('HealthandCARE - Recent Posts', 'healthandcare'), $widget_ops, $control_ops );
